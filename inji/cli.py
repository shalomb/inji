...
def cli_args():
    parser = argparse.ArgumentParser(description="inji - render jinja templates")
    ...
    parser.add_argument(
        ...
        action="append",
        required=False,
        type=lambda p, t="dir": utils.path(p, t),
        dest="overlay_dir",
        default=[],
    ...
    parser.add_argument(
        ...
        action="append",
        required=False,
        type=lambda p, t="file": utils.path(p, t),
        dest="vars_file",
        default=[],
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        dest="undefined_variables_mode",
        default="strict",
        choices=["strict", "empty", "keep", "StrictUndefined", "Undefined", "DebugUndefined"],
    ...
    parser.add_argument(
        ...
        action="version",
        version=_version(),
        help=f"print version number ({_version()})",
    )
...
def main():
    ...
    assert sys.version_info >= (3, 5), (
        f"Python version ({sys.version_info.major}.{sys.version_info.minor}) !>= 3.5"
    )
